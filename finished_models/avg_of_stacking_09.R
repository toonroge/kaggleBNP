...
db$PredictedProb <- 0.15 * db$predxgb7 + 0.05 * db$predxgb6 + 0.40 * db$predextc + 0.40 * db$predxgb8
...
write.csv(db, file = "./finished_models_output/avg_of_stacking_09_submission.csv", row.names = F)