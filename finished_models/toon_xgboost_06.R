...
keep_pattern <-
      c("MISSING_COUNT", "CATRANK", "RANK_DIVIDE") # to keep
ignore_pattern <-
...
model <-
      list(
            ...
            description = "XGB eta 0.01, depth 11, ntrees 750, min_child 1, colsample 0.8,
            subsample 0.8, data is all numeric features divided by v50, cat features only most ocurring",
