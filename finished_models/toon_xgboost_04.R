...
keep_pattern <-
      c(cat_vars, "hclust", "gpca_dist", "MISSING_COUNT") # to keep
ignore_pattern <-
...
model <-
      list(
            ...
            description = "XGB eta 0.005, depth 11, ntrees 1700, min_child 1, colsample 0.6,
            subsample 0.8, data after a clustering of correlated vars + PCA, v22 transformed
            via copy-paste transformation from forum, some PCA based feature for flagging outliers,
            feature giving pctg Missing values and median imputation for missing values",
