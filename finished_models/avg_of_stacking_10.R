...
db$PredictedProb <- 0.25 * db$predxgb7 + 0.25 * db$predxgb6 + 0.25 * db$predextc + 0.25 * db$predxgb8
...
write.csv(db, file = "./finished_models_output/avg_of_stacking_10_submission.csv", row.names = F)