...
db$PredictedProb <- 0.15 * db$predxgb7 + 0.15 * db$predxgb6 + 0.30 * db$predextc + 0.30 * db$predxgb9 + 0.10 * db$predxgb8
...
write.csv(db, file = "./finished_models_output/avg_of_stacking_12_submission.csv", row.names = F)